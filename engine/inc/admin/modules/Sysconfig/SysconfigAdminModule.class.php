 ...
 */
    ...
    public function main() {
      ...
      if ($this->globVar->isPost())
      {
       ...
       $this->_tplControls['dropdown'] = new \Controller\Template(NULL, POR_DEFECTO, $dropdownTpl[0]);
       
       $this->_tplControls['option'] = new \Controller\Template(NULL, POR_DEFECTO, $optionTpl[0]);
       $this->_tplControls['textbox'] = new \Controller\Template(NULL, POR_DEFECTO, $textboxTpl[0]);
       $this->_tplControls['dropdown']->setRefBlock('option', \Controller\Template::$Void);
       
       
       
       $this->_shortcutTpl = new \Controller\Template(NULL, POR_DEFECTO, $shortcutTpl[0]);
       $this->_tabContentTpl = new \Controller\Template(NULL, POR_DEFECTO, $tabContentTpl[0]);
       $this->_tabHeaderTpl = new \Controller\Template(NULL, POR_DEFECTO, $tabHeaderTpl[0]);
       $this->_configTpl = new \Controller\Template(NULL, POR_DEFECTO, $configTpl[0]);
